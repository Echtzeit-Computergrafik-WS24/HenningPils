...
const vertexShaderSource = `#version 300 es
    ...
    void main() {
        gl_Position = vec4(a_pos, 0.4, 1.0);
    }
    `;
...
vec3 palette(float t) {
    vec3 a = vec3(-0.3, -0.1, -0.1);
    vec3 b = vec3(0.1, 0.9, 0.1);
    vec3 c = vec3(0.0, 0.28, 0.0);
    vec3 d = vec3(-0.380, -2.547, -0.033);
  
    return a + b * cos(12.283185 * ((c*18.0) * t + (d*9.0))*c);
}
...
void main() {
    ...
    float edgeFade = smoothstep(0.002, 1.2, distFromCenter); // adjust fade range
